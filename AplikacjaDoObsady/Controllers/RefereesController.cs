...
namespace AplikacjaDoObsady.Controllers
{
    public class RefereesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RefereeId,FirstName,LastName,League,DateOfBirth,PhoneNumber,Email")] Referee referee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RefereeId,FirstName,LastName,League,DateOfBirth,PhoneNumber,Email")] Referee referee)
        {
